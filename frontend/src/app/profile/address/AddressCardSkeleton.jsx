const AddressCardSkeleton = () => {
    return (
        <div className="bg-background border border-border rounded-lg py-6 px-4">
            ...
            <div className="flex items-center justify-between gap-3 text-muted-fg xl:text-base md:text-super-sm text-sm mt-5">
