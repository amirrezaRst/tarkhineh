...
const PaymentGateway = () => {
    ...
    if (paymentMethod == "cash") return (
        <div
            className="flex md:flex-row flex-col md:items-center xl:gap-8 gap-4 border border-border rounded-lg xl:px-9 px-4 xl:py-10 md:py-8 py-4"
        >

            <div className="flex items-center gap-2 md:border-b-0 border-b border-b-border md:pb-0 pb-4 md:mb-0 mb-1">
                <WarningIcon className="fill-foreground md:w-7 md:h-7" />
                <p className="lg:text-lg md:text-base text-super-sm text-foreground">
                    قابل توجه
                </p>
            </div>
            <p className="flex-1 xl:text-super-sm md:text-sm text-xs md:leading-6 leading-5 text-muted-fg">
    ...
    return (
        <div className="border border-border rounded-lg xl:px-9 px-4 xl:py-10 md:py-8 py-4">
            <div className="flex items-center gap-1.5 md:border-b-0 border-b border-b-border md:pb-0 pb-4 md:mb-0 mb-1">
                <PersonalWalletIcon className="md:w-7 md:h-7 fill-foreground" />
                <p className="text-foreground lg:text-lg md:text-base text-super-sm">درگاه پرداخت</p>
            </div>
            ...
            <p className="md:text-sm text-[10px] text-muted-fg text-center">
                پرداخت از طریق کلیه کارت‌های عضو شتاب امکان‌پذیر است.‌ <br />
            </p>
            <p className="md:text-super-xs text-[10px] text-muted-fg text-center mt-1">
