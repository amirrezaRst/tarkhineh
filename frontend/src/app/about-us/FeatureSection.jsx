...
const features = [
    {
        icon: <UserIcon className="md:w-14 md:h-14 w-12 h-12 fill-foreground" />,
        title: "پرسنلی مجرب و حرفه ای"
    },
    {
        icon: <DiagramIcon className="md:w-14 md:h-14 w-12 h-12 fill-foreground" />,
        title: "کیفیت بالای غذا"
    },
    {
        icon: <HomeWifiIcon className="md:w-14 md:h-14 w-12 h-12 fill-foreground" />,
        title: "محیطی دلنشین و آرام"
    },
    {
        icon: <MenuBoardIcon className="md:w-14 md:h-14 w-12 h-12 fill-foreground" />,
        title: "منوی متنوع"
    },
]
