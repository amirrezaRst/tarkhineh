            ...
            <div className="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full pt-4">
                <ul className="flex flex-col pl-0 gap-3 mb-0">
                    ...
                    <li className="mt-0.5 w-full">
                        ...
                        >
                            <div className="bg-gradient-to-tl mr-2 flex h-10 w-10 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                <FastFoodMenuIcon className="fill-[#717171] w-7 h-7" />
                            </div>
                            <span className="mr-1.5 duration-300 opacity-100 pointer-events-none ease-soft">منو رستوران</span>
                        </Link>
                    </li>
                    ...
                    <li className="mt-0.5 w-full">
                        ...
                        >
                            <div className="bg-gradient-to-tl mr-2 flex h-10 w-10 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                <DeliveryIcon className="fill-[#717171] w-7 h-7" />
                            </div>
                            <span className="mr-1.5 duration-300 opacity-100 pointer-events-none ease-soft">پیک ها</span>
                        </Link>
                    </li>
                    ...
                    <li className="mt-0.5 w-full">
                        ...
                        >
                            <div className="bg-gradient-to-tl mr-2 flex h-10 w-10 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                <FastFoodIcon className="fill-[#717171] w-7 h-7" />
                            </div>
                            <span className="mr-1.5 duration-300 opacity-100 pointer-events-none ease-soft">سفارش ها</span>
                        </Link>
                    </li>
                    ...
                    <li className="mt-0.5 w-full">
                        ...
                        >
                            <div className="bg-gradient-to-tl mr-2 flex h-10 w-10 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                <DiagramIcon className="fill-[#717171] w-7 h-7" />
                            </div>
                            <span className="mr-1.5 duration-300 opacity-100 pointer-events-none ease-soft">گزارشات</span>
                        </Link>
                    </li> */}
